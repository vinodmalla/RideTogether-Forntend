...
export const connectSocket = () => { // Define a function called connectSocket that will be used to establish a connection to the socket server.
    return io("https://ridetogether-backend.onrender.com",{
          transports: ["websocket"],
    }); // Use the io function to connect to the socket server at the specified URL (http://localhost:5000) and return the socket instance.
}
